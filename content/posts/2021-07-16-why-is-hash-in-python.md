...
I am hoping that, like myself when I began this exercise, you have no
...
Where would we find the `tp_hash` of `-1`? Let's do another search for
`tp_hash`:
...
Note that I have removed a big chunk of the implementation details.
